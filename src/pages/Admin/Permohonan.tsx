import TabelPermohonan from "../../components/manajemen-tabel/TabelPermohonan";
...
export default function Data() {
  ...
  const Keputusan = async(id: any, keputusan: any) => {
    await axios.patch(import.meta.env.VITE_API + '/peminjaman/' + id, keputusan, {headers: {authorization:token}})
    getData()
  }
    ...
    <>
      ...
      <div className="">
        ...
        <div className="col-span-12 xl:col-span-7">
          <TabelPermohonan data={data} barang={dataBarang} onTambah={postData} onKeputusan={Keputusan} />
        </div>
      </div>
    </>
  );
